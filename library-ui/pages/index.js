...
const Home = () => {
  ...
  return (
    <>
      ...
      <Box>
        {/* Hero section */}
        <Flex bg='linear-gradient(98.41deg, #02081F 0%, #1A0830 96.87%)' width='100vw' height='90vh' mb={10} px='90px'>
          <Box>
            <Box pt='5%' mb={10}>
              <Flex>
                <Heading
          ...
          <iframe src='https://embed.lottiefiles.com/animation/99349' width={700} height={700}></iframe>
        </Flex>

...
const Home = () => {
  ...
  return (
    <>
      ...
      <Box>
        {/* Hero section */}
        <Box bg='linear-gradient(98.41deg, #02081F 0%, #1A0830 96.87%)' width='100vw' height='90vh' mb={10} px='90px'>
          <Box pt='5%' mb={10}>
            <Heading
          ...
          <Flex>
            ...
            <Box w='40%'>
              <Text fontSize='20px' fontWeight='500' color='#E2E0E5' mb={5}>
                Delibra is the first read to earn decentalized platform that gives instant access to ebooks, audiobooks,
                articles, podcasts, sheet music, and documents.
              </Text>
              <Button
                fontSize='18px'
                fontWeight='700'
        ...
        <Box bg='#ffffff' width='100vw' minH='50vh' px='100px' py={10} mb={10}>
          ...
          <Flex justify='space-between' my={10}>
            ...
            <FeatureCard
              ...
              cont='Buy books conveniently on the blockchain with a single click of a button. '
            />
        ...
        <Box py={10} px='100px' minH='50vh' textAlign='center' pos='relative'>
          ...
          />
          <Tag color='#EAA391' bg='#FFEBE1' borderRadius='86px' fontSize='16px' fontWeight='700' px={4} py={2} mb={5}>
            OUR GOAL IS SIMPLE
          </Tag>
          <Heading
            fontFamily="'Clash Grotesk', sans-serif"

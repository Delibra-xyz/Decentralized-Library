  ...
  return (
    <div className={styles.roadmapStepper}>
      <div className={styles.roadmapStepper__container}>
        <span
          className={`${styles.roadmapStepper__thumb}   ${styles.one}`}
        ></span>
        <div
          className={`${styles.roadmapStepper__content__wrapper} ${styles.left}`}
        >
          <h2 className={styles.roadmapStepper__heading}>Milestone 1 </h2>
          <ul className={styles.roadmapStepper__item}>
            <li className={styles.roadmapStepper__content}>
              Design a landing page in Figma first, then work on workflow and
              prototypes.
            </li>
            <li className={styles.roadmapStepper__content}>
              {' '}
            ...
            <li className={styles.roadmapStepper__content}>
              {' '}
              Social media accounts would be created, and regular content
              posting would commence.
            </li>
            <li className={styles.roadmapStepper__content}>
              {' '}
              Smart contract Implementation for the book covers that would be
              minted as NFTs
            </li>
          </ul>
        </div>
      ...
      <div className={styles.roadmapStepper__container} id="roadmap-cont-2">
        ...
        ></span>
        <div
          className={`${styles.roadmapStepper__content__wrapper}  ${styles.right}`}
        >
          <h2 className={styles.roadmapStepper__heading}>Milestone 2 </h2>
          <ul className={styles.roadmapStepper__item}>
            <li className={styles.roadmapStepper__content}>
      ...
      <div className={styles.roadmapStepper__container}>
        ...
        >
          ...
          <ul className={styles.roadmapStepper__item}>
            ...
            <li className={styles.roadmapStepper__content}>
              Users can upload an NFT connected to their wallet address as their
              profile picture.
            </li>
            <li className={styles.roadmapStepper__content}>
